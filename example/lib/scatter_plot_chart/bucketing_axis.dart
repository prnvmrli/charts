...
class BucketingAxisScatterPlotChart extends StatelessWidget {
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData() {
    final myFakeDesktopData = [new LinearSales(52, 0.75, 14.0)];

    final myFakeTabletData = [new LinearSales(45, 0.3, 18.0)];

    final myFakeMobileData = [new LinearSales(56, 0.8, 17.0)];

    final myFakeChromebookData = [new LinearSales(25, 0.6, 13.0)];

    final myFakeHomeData = [new LinearSales(34, 0.5, 15.0)];
