...
import 'time_series_chart/time_series_gallery.dart'
    as time_series
    show buildGallery;
import 'line_chart/line_gallery.dart' as line show buildGallery;
import 'scatter_plot_chart/scatter_plot_gallery.dart'
    as scatter_plot
    show buildGallery;
...
class Home extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    galleries.addAll(
      timeSeriesGalleries.map(
        (gallery) => gallery.buildGalleryListTile(context),
      ),
    );
    ...
    galleries.addAll(
      legendsGalleries.map((gallery) => gallery.buildGalleryListTile(context)),
    );
