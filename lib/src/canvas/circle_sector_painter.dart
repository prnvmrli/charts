...
import 'package:charts_flutter/common.dart' as common show Color;
...
class CircleSectorPainter {
  ...
  static void draw({
    ...
    if (isFullCircle) {
      path.arcTo(
        new Rect.fromCircle(center: centerOffset, radius: radius),
        startAngle,
    ...
    if (isFullCircle) {
      path.arcTo(
        new Rect.fromCircle(center: centerOffset, radius: innerRadius),
        endAngle,
