...
import 'package:charts_flutter/src/chart/cartesian/axis/spec/axis_spec.dart'
    show TextStyleSpec;
import 'package:charts_flutter/src/chart/common/behavior/legend/legend_entry.dart';
import 'package:charts_flutter/src/chart/common/behavior/legend/legend_entry_generator.dart';
...
class PerSeriesLegendEntryGenerator<D> implements LegendEntryGenerator<D> {
  ...
  void _updateFromSeriesList(
    ...
    for (final entry in legendEntries) {
      ...
      entry
        ..value = seriesAndMeasure[seriesId]
