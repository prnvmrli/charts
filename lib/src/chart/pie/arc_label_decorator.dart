...
import 'dart:math' show Point, Rectangle, cos, min, pi, sin;
...
class ArcLabelDecorator<D extends Object> extends ArcRendererDecorator<D> {
  ...
  static const _defaultInsideLabelStyle = TextStyleSpec(
    fontSize: 12,
    color: Color.white,
  );
  static const _defaultOutsideLabelStyle = TextStyleSpec(
    fontSize: 12,
    color: Color.black,
  );
...
class ArcLabelLeaderLineStyleSpec {
  ...
  bool operator ==(Object other) =>
      other is ArcLabelLeaderLineStyleSpec &&
      color == other.color &&
