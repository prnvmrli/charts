...
import 'package:charts_flutter/src/chart/treemap/treemap_renderer_decorator.dart';
import 'package:charts_flutter/src/chart/treemap/treemap_renderer_element.dart';
...
import 'package:charts_flutter/src/common/text_utils.dart';
...
class TreeMapLabelDecorator<D> extends TreeMapRendererDecorator<D> {
  ...
  static const _defaultLabelStyle = TextStyleSpec(
