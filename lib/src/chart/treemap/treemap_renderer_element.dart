...
class TreeMapRendererElement<D> {
  ...
  String toString() =>
      '$runtimeType${{'boundingRect': boundingRect, 'area': area, 'strokeColor': strokeColor, 'strokeWidthPx': strokeWidthPx, 'fillColor': fillColor, 'fillPattern': fillPattern, 'patternColor': patternColor, 'isLeaf': isLeaf, 'index': index, 'domain': domain, 'measure': measure}}';
}
