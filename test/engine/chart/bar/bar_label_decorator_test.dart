...
import 'package:charts_flutter/src/common/text_measurement.dart'
    show TextMeasurement;
import 'package:charts_flutter/src/common/text_style.dart' show TextStyle;
import 'package:charts_flutter/src/data/series.dart' show AccessorFn;
...
void main() {
  ...
  setUpAll(() {
    ...
    drawBounds = const Rectangle(0, 0, 200, 100);
  });

  group('vertical bar chart', () {
    test('Paint labels with default settings', () {
      final data = ['A', 'B', 'C'];
      const leftPositionA = 0;
      const leftPositionB = 25;
      const leftPositionC = 50;
      const topPositionA = 50;
      const topPositionB = 95;
      const topPositionC = 50;
      const barWidthA = 20;
      const barWidthB = 20;
      const barWidthC = 4;
      final barElements = [
    ...
    group('Null and empty label scenarios', () {
      test('Skip label if label accessor does not exist', () {
        final barElements = [
          FakeBarRendererElement('A', const Rectangle(0, 0, 10, 20), null, [
            'A',
          ]),
        ];
