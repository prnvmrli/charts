...
import 'package:charts_flutter/src/chart/cartesian/axis/axis_tick.dart'
    show AxisTicks;
...
import 'package:charts_flutter/src/chart/cartesian/axis/range_axis_tick.dart'
    show RangeAxisTicks;
import 'package:charts_flutter/src/chart/cartesian/axis/range_tick.dart'
    show RangeTick;
...
abstract class Axis<D> extends ImmutableAxis<D> implements LayoutView {
  ...
  @override
  int compareDomainValueToViewport(D domain) =>
      scale!.compareDomainValueToViewport(domain);
  ...
  @override
  ViewMeasuredSizes measure(int maxWidth, int maxHeight) => isVertical
